...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-space-950/90 backdrop-blur-xl border-t border-white/[0.06] safe-area-bottom">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'text-nebula-400' : 'text-surgical-100/30 hover:text-surgical-100/60'
              )}
            >
              <div className={cn(
                'p-1.5 rounded-xl transition-all duration-200',
                active && 'bg-nebula-500/10'
              )}>
